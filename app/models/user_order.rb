class UserOrder
  ...
  def save
    ...
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, building: building, address: address, phone_number: phone_number, order_id: order.id)
  end
end
