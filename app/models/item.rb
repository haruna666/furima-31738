class Item < ApplicationRecord
	...
	validates :name, :price, :detail, :category_id, :quality_id, :prefecuture_id, :shipped_date_id, :shipment_burden_id, :user_id, presence: true

	validates :category_id, numericality: { other_then: 1 }
	validates :quality_id, numericality: { other_then: 1 }
	validates :prefecuture_id, numericality: { other_then: 1 }
